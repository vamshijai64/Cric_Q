...
exports.updateMovieNewsById = async (req, res) => {

   try{
     const {title, description, imageUrl} = req.body;
     const movienewsId=req.params.id;
        const news = await movieNewsService.updateMovieNewsById(movienewsId, title, description, imageUrl);
