...
//     const latestMovieNewsRaw = await movieNewsmodel
//       .findOne()
//       .sort({ createdAt: -1 })
//       .select("_id title description imageUrl createdAt");
...
//     // Prepare movieNews with only landscape images
//     const latestMovieNews = latestMovieNewsRaw
//       ? {
//           ...latestMovieNewsRaw.toObject(),
//           imageUrl: latestMovieNewsRaw.imageUrl.map(img => ({
...
//     const movieNewsRaw = await movieNewsmodel
//       .find()
//       .sort({ createdAt: -1 })
//       .limit(10)
//       .select("_id title description imageUrl createdAt");

//     const movieNews = movieNewsRaw.map(news => ({
//       ...news.toObject(),
//       imageUrl: news.imageUrl.map(img => ({
//         landscape: img.landscape,
//       })),
//     }));
...
//           _id: category._id,
//           title: category.title,
//           imageUrl: category.imageUrl.landscape,
//           subcategories,
//         };
//       })
//     );
